...
$result_funkopop = "SELECT * FROM canecas";
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <link href="css/canecas.css" rel="stylesheet">
						...
						<div class="card">
                            ...
                            <div class="tam">
                                <?php
                                    ...
                                    echo ' <img width="190" height="175" src="data:image/jpeg;base64,'.base64_encode($rows_funkopop['imagem'] ).'" />  ';  
							...
							<div class="caption text-center">
                                <a class="nome" href="detalhes_canecas.php?id_curso=<?php echo $rows_funkopop['id']; ?>"><h3><?php echo $rows_funkopop['nome']; ?></h3></a>
							    <strong><?php echo $rows_funkopop['preco']; ?> </strong>
                                <p><a href="detalhes_canecas.php?id_curso=<?php echo $rows_funkopop['id']; ?>" class="botão" role="button">Detalhes</a> </p>
							</div>
						</div>
					</div>
				<?php } ?>
